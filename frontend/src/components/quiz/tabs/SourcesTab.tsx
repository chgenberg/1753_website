    ...
    >
      ...
      <div className="bg-gradient-to-r from-[#F5F3F0] to-[#FAF9F7] rounded-2xl p-8 border border-[#E5DDD5]">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-2xl font-serif text-[#4A3428]">Vetenskaplig Grund</h3>
        </div>
      ...
      <div className="space-y-6">
        {sources.map((category, idx) => (
          <div key={idx} className="bg-white rounded-2xl p-8 shadow-lg border border-[#E5DDD5]">
            <h3 className="text-xl font-serif text-[#4A3428] mb-4">{category.category}</h3>
            <div className="space-y-4">
              {category.references.map((ref, refIdx) => (
                <div key={refIdx} className="border-l-4 border-[#8B7355] pl-4">
                  <h4 className="font-medium text-[#4A3428]">{ref.title}</h4>
                  ...
                  <a 
                    ...
                    className="inline-flex items-center text-[#8B7355] hover:text-[#4A3428] mt-2 text-sm"
                  >
                    Läs hela studien
      ...
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#E5DDD5]">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-xl font-serif text-[#4A3428]">Rekommenderad Läsning</h3>
        </div>
        <ul className="space-y-3 text-[#4A3428]">

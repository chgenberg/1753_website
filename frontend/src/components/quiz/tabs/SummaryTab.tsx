  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#E5DDD5]">
        <h3 className="text-2xl font-serif text-[#FCB237] mb-6">Din Hudprofil</h3>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="text-center">
            <div className="relative w-32 h-32 mx-auto mb-4">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-2xl font-bold text-[#FCB237]">{results.ecosystemBalance.microbiome}%</span>
              </div>
            </div>
            <h4 className="font-semibold text-[#FCB237] mb-2">Mikrobiom Balans</h4>
          ...
          <div className="text-center">
            <div className="relative w-32 h-32 mx-auto mb-4">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-2xl font-bold text-[#FCB237]">{results.ecosystemBalance.endocannabinoid}%</span>
              </div>
            </div>
            <h4 className="font-semibold text-[#FCB237] mb-2">Endocannabinoid Balans</h4>
          ...
          <div className="text-center">
            <div className="relative w-32 h-32 mx-auto mb-4">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-2xl font-bold text-[#FCB237]">{results.ecosystemBalance.barrier}%</span>
              </div>
            </div>
            <h4 className="font-semibold text-[#FCB237] mb-2">Hudbarriär Styrka</h4>
        ...
        <div className="border-t border-[#E5DDD5] pt-6">
          <h4 className="font-semibold text-[#FCB237] mb-4">Dina Huvudsakliga Hudutmaningar:</h4>
          <div className="space-y-3">
            {results.primaryConcerns.map((concern: string, index: number) => (
              <div key={index} className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 text-[#8B7355] mt-0.5" />
                <div>
                  <p className="text-[#FCB237] font-medium">{concern}</p>
      ...
      <div className="bg-gradient-to-r from-[#F5F3F0] to-[#FAF9F7] rounded-2xl p-8 border border-[#E5DDD5]">
        <h3 className="text-2xl font-serif text-[#FCB237] mb-6">Holistisk Hudanalys</h3>
        <div className="prose prose-stone max-w-none">
          ...
          <p className="text-[#FCB237] leading-relaxed mt-4">
      ...
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#E5DDD5]">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-xl font-serif text-[#FCB237]">Evolutionär Förståelse</h3>
        </div>
        <p className="text-[#FCB237] leading-relaxed">
